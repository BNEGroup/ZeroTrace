...
export default function ErinnerungEintrag({ eintrag }) {
  const istÜberfällig = eintrag.faellig && eintrag.faellig < new Date().toISOString().split("T")[0];

  return (
    <Card className={`mb-4 ${istÜberfällig ? "bg-red-100 dark:bg-red-800/20" : ""}`}>
