    ...
    <Card className="mb-4">
      <CardContent className="p-4">
        <div className="flex justify-between items-center mb-2">
          <div>
            <p className="font-semibold">{eintrag.datum} – {eintrag.tachostand} km – {eintrag.kostenart}</p>
            <p className="text-sm">{eintrag.betrag} {eintrag.waehrung || "EUR"}<br />{eintrag.bemerkung}</p>
            {eintrag.synced === false && <p className="text-xs text-yellow-500">nicht synchronisiert</p>}
          </div>
