...
export default function Kosten() {
  return (
    <div className="min-h-screen p-4 bg-background text-foreground">
      <h1 className="text-2xl font-bold mb-4">Kostenübersicht</h1>
            ...
            <Card>
              <CardContent className="p-4 space-y-2">
                <div className="flex justify-between">
                  <div>
                    <p className="font-semibold">17.02.2025</p>
                    <p className="text-sm text-muted">237.039 km • HVO100</p>
                  </div>
                  <div className="text-right">
                    <p className="font-semibold">7,12 l/100km</p>
                    <p className="text-sm text-muted">53,40 l • 95,00 EUR</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            {/* Weitere Tankkarten später dynamisch */}
          </div>
        </TabsContent>
